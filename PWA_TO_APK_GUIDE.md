...
5. **Configure Android Settings**
   - **Package ID:** `com.sprotofishing.app`
   - **App Name:** `Sproto Fishing`
   - **Version:** `1.0.0`
   - **Min SDK:** `21` (Android 5.0+)
   - **Target SDK:** `34` (Android 14)

6. **Sign the APK (for Play Store)**
   - Generate a keystore: `keytool -genkey -v -keystore sproto.keystore -alias sproto -keyalg RSA -keysize 2048 -validity 10000`
...
cd C:\Users\roota\sproto

# Initialize Bubblewrap project
bubblewrap init --manifest https://sprotofishing.fun/manifest.json

# Answer the prompts:
# Domain: sprotofishing.fun
# Package ID: com.sprotofishing.app
# App Name: Sproto Fishing
...
keytool -genkey -v -keystore sproto-release.keystore -alias sproto -keyalg RSA -keysize 2048 -validity 10000

# Sign the APK
jarsigner -verbose -sigalg SHA256withRSA -digestalg SHA-256 -keystore sproto-release.keystore app-release-unsigned.apk sproto

# Optimize (zipalign)
zipalign -v 4 app-release-unsigned.apk sproto-release.apk
```
...
2. **Create New Project**
   ...
   - Package name: `com.sprotofishing.app`
...
<activity
    ...
    <meta-data
        ...
        android:value="https://sprotofishing.fun" />
    <intent-filter>
    ...
    <intent-filter android:autoVerify="true">
        ...
        <data android:scheme="https" android:host="sprotofishing.fun" />
    </intent-filter>
</activity>
```
...
Create: `C:\Users\roota\sproto\public\.well-known\assetlinks.json`
...
[{
  ...
  "target": {
    ...
    "package_name": "com.sprotofishing.app",
...
```bash
keytool -list -v -keystore sproto-release.keystore -alias sproto
```

The file must be accessible at: `https://sprotofishing.fun/.well-known/assetlinks.json`
...
6. **Privacy Policy**
   ...
   - Host at: `https://sprotofishing.fun/privacy.html`
...
# Install APK
adb install sproto-release.apk
...
- **PWA must be HTTPS** - already done (sprotofishing.fun)
