...
### 1. **SPROTO_TREASURY_SECRET** (REQUIRED)
...
### 2. **VITE_SPROTO_MINT** (Already set in code)
...
vercel env add SPROTO_TREASURY_SECRET production
...
SPROTO_TREASURY_SECRET=<your_key>
...
### Production Testing:
1. Connect wallet on https://sprotofishing.fun
...
- [ ] `SPROTO_WITHDRAW_MAX` set to reasonable limit
...
- Set `SPROTO_TREASURY_SECRET` and `VITE_SPROTO_MINT` in Vercel env
...
`https://sprotofishing.fun/api/withdraw`
