# Sproto Treasury Wallet Configuration
...
export const SPROTO_MINT = parsePubkeyOrNull(
  import.meta.env.VITE_SPROTO_MINT || 
  "HBibqRqqzAbnvZ4ogkcma6nzaoNWgpEimajVjHA3pump"
);

// Treasury Wallet Address
export const TIDE_TREASURY = parsePubkeyOrNull(
  import.meta.env.VITE_SPROTO_TREASURY || 
  "CYV4qsTPCDNfo9acpL7ni9jTzxZoZLbkjSQ7C25smror"
);
```
...
```bash
VITE_SPROTO_MINT=<your_test_token_mint>
VITE_SPROTO_TREASURY=<your_test_wallet_address>
```
...
### Local Testing:
1. Set `VITE_SPROTO_MINT` to your test token mint
2. Set `VITE_SPROTO_TREASURY` to your test wallet
