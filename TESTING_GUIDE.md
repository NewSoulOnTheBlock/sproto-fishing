...
**Backend Deployed:**
- ✅ API server on Render: https://sproto-fishing.onrender.com
...
### 1. Connect Wallet
1. Go to https://sprotofishing.fun
...
### Check API Health
```bash
curl https://sproto-fishing.onrender.com/health
```
...
### Test Authentication
```bash
curl -X POST https://sproto-fishing.onrender.com/api/player/auth \
...
### Check Leaderboard
```bash
curl https://sproto-fishing.onrender.com/api/leaderboard?limit=10
```
...
- **Check:** https://sproto-fishing.onrender.com/health
