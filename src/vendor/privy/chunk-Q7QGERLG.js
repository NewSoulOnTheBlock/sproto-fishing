...
import {
  ...
  r,
  t
} from "./chunk-2UPDRTGD.js";
import {
  CaipNetworksUtil,
  ConnectorUtil,
  HelpersUtil,
  WalletUtil
} from "./chunk-IEEPB2YB.js";
import {
  A,
  UiHelperUtil,
  b,
...
var __decorate = function(decorators, target, key, desc) {
  var c2 = arguments.length, r4 = c2 < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r4 = Reflect.decorate(decorators, target, key, desc);
  else for (var i4 = decorators.length - 1; i4 >= 0; i4--) if (d = decorators[i4]) r4 = (c2 < 3 ? d(r4) : c2 > 3 ? d(target, key, r4) : d(target, key)) || r4;
...
var W3mConnectorList = class W3mConnectorList2 extends i2 {
  ...
  mapConnectorsToExplorerWallets(connectors, explorerWallets) {
    return connectors.map((connector) => {
      if (connector.type === "MULTI_CHAIN" && connector.connectors) {
        const connectorIds = connector.connectors.map((c2) => c2.id);
        const connectorNames = connector.connectors.map((c2) => c2.name);
        const connectorRdns = connector.connectors.map((c2) => c2.info?.rdns);
  ...
  connectorListTemplate() {
    ...
    const external = this.processConnectorsByType(byType.external.filter((c2) => c2.id !== ConstantsUtil.CONNECTOR_ID.COINBASE_SDK));
...
var WuiTab = class WuiTab2 extends i2 {
  constructor() {
    super(...arguments);
    this.icon = "mobile";
    this.size = "md";
  ...
  generate({ uri, size, logoSize, padding = 8, dotColor = "var(--apkt-colors-black)" }) {
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i4 = 0; i4 < qrList.length; i4 += 1) {
        ...
        dots.push(w`
            <rect
              fill=${i4 === 2 ? "var(--apkt-colors-black)" : "var(--apkt-colors-white)"}
        ...
        if (matrix[i4][j2]) {
          if (!(i4 < QRCODE_MATRIX_MARGIN && j2 < QRCODE_MATRIX_MARGIN || i4 > matrix.length - (QRCODE_MATRIX_MARGIN + 1) && j2 < QRCODE_MATRIX_MARGIN || i4 < QRCODE_MATRIX_MARGIN && j2 > matrix.length - (QRCODE_MATRIX_MARGIN + 1))) {
            if (!(i4 > matrixMiddleStart && i4 < matrixMiddleEnd && j2 > matrixMiddleStart && j2 < matrixMiddleEnd)) {
              const cx = i4 * cellSize + cellSize / 2 + padding;
              const cy = j2 * cellSize + cellSize / 2 + padding;
              circles.push([cx, cy]);
            }
          }
        }
...
var s = (i4, t3) => {
  ...
  for (const i5 of e3) i5._$AO?.(t3, false), s(i5, t3);
  return true;
};
var o2 = (i4) => {
  let t3, e3;
...
function n2(i4, t3 = false, e3 = 0) {
  const r4 = this._$AH, h3 = this._$AN;
  if (void 0 !== h3 && 0 !== h3.size) if (t3) if (Array.isArray(r4)) for (let i5 = e3; i5 < r4.length; i5++) s(r4[i5], false), o2(r4[i5]);
  else null != r4 && (s(r4, false), o2(r4));
  else s(this, i4);
}
var c = (i4) => {
  i4.type == t.CHILD && (i4._$AP ??= n2, i4._$AQ ??= h);
};
var f = class extends i3 {
  constructor() {
    super(...arguments), this._$AN = void 0;
  }
  _$AT(i4, t3, e3) {
    super._$AT(i4, t3, e3), r3(this), this.isConnected = i4._$AU;
  }
  _$AO(i4, t3 = true) {
    i4 !== this.isConnected && (this.isConnected = i4, i4 ? this.reconnected?.() : this.disconnected?.()), t3 && (s(this, i4), o2(this));
  }
  setValue(t3) {
    if (r2(this._$Ct)) this._$Ct._$AI(t3, this);
    else {
...
var n3 = e(class extends f {
  render(i4) {
    return A;
  }
  update(i4, [s2]) {
    const e3 = s2 !== this.G;
    return e3 && this.rt(void 0), (e3 || this.lt !== this.ct) && (this.G = s2, this.ht = i4.options?.host, this.rt(this.ct = i4.element)), A;
  }
  rt(t3) {
...
var WuiToggle = class WuiToggle2 extends i2 {
  constructor() {
    super(...arguments);
    this.inputElementRef = e2();
    this.checked = false;
    this.disabled = false;
    this.size = "md";
  }
...
var WuiSearchBar = class WuiSearchBar2 extends i2 {
  constructor() {
    super(...arguments);
    this.inputComponentRef = e2();
    this.inputValue = "";
  }
  render() {
    return b`
      <wui-input-text
        ${n3(this.inputComponentRef)}
