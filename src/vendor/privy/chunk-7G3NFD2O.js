...
async function Gr(t, e, n3) {
  return (await Vs({ hash: hn(e), signature: n3 })).toLowerCase() === t.toLowerCase();
}
async function zr(t, e, n3, r2, o2, s2) {
  const i4 = Je(r2);
...
var R3 = (S5, o2) => {
  ...
  if (vt2) for (var t of vt2(o2)) Vs2.call(o2, t) && $e2(S5, t, o2[t]);
  return S5;
};
...
__reExport(networks_exports, chains_star);
import * as chains_star from "viem/chains";
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./chunk-XPVX25AH.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./chunk-Q7QGERLG.js");
      await import("./chunk-ZVQG7VL7.js");
