...
// node_modules/@privy-io/react-auth/dist/esm/shared-BE2xpXR-.mjs
var l = ft`
  font-size: 14px;
  font-style: normal;
  font-weight: 400;
...
var u = gt.div`
  ...
  align-items: center;
`;
var w = gt(ArrowPathIcon_default)`
  height: 1.25rem;
  width: 1.25rem;
...
`;
var b2 = gt(EyeSlashIcon_default)`
  height: 1.25rem;
  width: 1.25rem;
  stroke: var(--privy-color-accent);
  cursor: pointer;
