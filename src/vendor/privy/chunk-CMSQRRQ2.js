...
function __decorate(decorators, target, key, desc) {
  ...
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r2 = (c3 < 3 ? d2(r2) : c3 > 3 ? d2(target, key, r2) : d2(target, key)) || r2;
...
function __createBinding(o4, m2, k, k2) {
  if (k2 === void 0) k2 = k;
  o4[k2] = m2[k];
}
...
function __values(o4) {
  var s = typeof Symbol === "function" && Symbol.iterator, m2 = s && o4[s], i = 0;
  if (m2) return m2.call(o4);
  if (o4 && typeof o4.length === "number") return {
    next: function() {
      if (o4 && i >= o4.length) o4 = void 0;
      return { value: o4 && o4[i++], done: !o4 };
    }
  };
  throw new TypeError(s ? "Object is not iterable." : "Symbol.iterator is not defined.");
}
function __read(o4, n2) {
  var m2 = typeof Symbol === "function" && o4[Symbol.iterator];
  if (!m2) return o4;
  var i = m2.call(o4), r2, ar = [], e2;
  try {
...
function __asyncDelegator(o4) {
  ...
  function verb(n2, f2) {
    i[n2] = o4[n2] ? function(v2) {
      return (p2 = !p2) ? { value: __await(o4[n2](v2)), done: n2 === "return" } : f2 ? f2(v2) : v2;
    } : f2;
  }
}
...
var o2 = class extends r {
  ...
  async requestStrict(t, e2) {
    return new Promise(async (i, s) => {
      ...
      this.events.on(`${t.id}`, (n2) => {
        isJsonRpcError(n2) ? s(n2.error) : i(n2.result);
      });
      try {
...
var p = (r2, t) => {
  ...
  if (c2) for (var e2 of c2(t)) O.call(t, e2) && l(r2, e2, t[e2]);
  return r2;
};
var v = (r2, t) => w(r2, E(t));
