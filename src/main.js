...
import { DockVisitor } from "./world/dockVisitor.js";
...
const dockVisitor = new DockVisitor(scene);
window.__pepe = dockVisitor; // tune approach/kick placement live, like __angler
