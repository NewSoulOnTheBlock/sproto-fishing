...
// The game's own helper contracts (bait store, reward escrow, vaults below)
// were deployed on the previous chain and have NO code at these addresses on
// Ethereum mainnet. They must be redeployed and these defaults overridden
// before any of those on-chain features work again.
export const HELPER_CONTRACTS_DEPLOYED = false;
