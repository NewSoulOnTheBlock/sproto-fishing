...
const SLIDES = [
  ...
  },
  {
    ...
    body: "In <b>Pro Angler</b> mode, every cast spends <b>1 bait</b>, so stock up in the <b>Shop</b> first — you start with none. <b>Cheaper bait</b> lands mostly common fish; <b>pricier bait</b> tilts your odds toward rare, epic &amp; legendary catches. Buy bait with <b>ETH</b> or <b>$BITCOIN</b> — same value either way. <i>(Casual mode needs no bait.)</i>",
  },
  {
