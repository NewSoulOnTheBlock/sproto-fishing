...
const SLIDES = [
  {
    ...
    title: "Casual or Pro?",
    body: "Tap the <b>mode button</b> (top corner) to switch anytime. <b>🎣 Casual Angler</b> — just fish for fun: <b>no bait needed</b>, cast freely, and every catch still fills your Journal (catch &amp; release, no $SPROTO). <b>💰 Pro Angler</b> — the full economy: each cast spends <b>bait</b> and your catches are worth real <b>$SPROTO</b> to sell. New anglers start in Casual.",
  },
  {
    icon: ICON('<path d="M16 9v6a5 5 0 0 1 -10 0v-1" /><path d="M10 5a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M12 7v2" />'),
    title: "Bait every cast",
    body: "In <b>Pro Angler</b> mode, every cast spends <b>1 bait</b>, so stock up in the <b>Shop</b> first — you start with none. <b>Cheaper bait</b> lands mostly common fish; <b>pricier bait</b> tilts your odds toward rare, epic &amp; legendary catches. Buy bait with <b>ETH</b> or <b>$SPROTO</b> — same value either way. <i>(Casual mode needs no bait.)</i>",
  },
  {
  ...
  },
  {
    ...
    title: "Spots, $SPROTO &amp; beyond",
    body: "Spot drifting <b>ripple rings</b> on the water? Cast into one for faster bites and rarer fish. Every catch earns <b>$SPROTO</b> and XP — sell your haul, upgrade gear, unlock new waters, and climb the leaderboard. <b>Tight lines!</b>",
  },
];
