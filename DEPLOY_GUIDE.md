...
git remote add origin https://github.com/YOUR_USERNAME/sproto.git
...
5. **Click "Create Web Service"**
   ...
   - You'll get a URL like: `https://sproto-api.onrender.com`
   - Save this URL!
...
# Paste: https://sproto-api.onrender.com
```
...
1. **Check API health:**
   ```bash
   curl https://sproto-api.onrender.com/api/health
   ```

2. **Check treasury balance:**
   ```bash
   curl https://sproto-api.onrender.com/api/treasury/balance
   ```
