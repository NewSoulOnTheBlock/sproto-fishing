// POST /api/withdraw
//
// Transfers $SBF from the Sproto treasury wallet to a player's connected
...
const SPROTO_MINT_STR = process.env.VITE_SPROTO_MINT || "HBibqRqqzAbnvZ4ogkcma6nzaoNWgpEimajVjHA3pump";
const SECRET_STR = process.env.SPROTO_TREASURY_SECRET || "";
const TIDE_DECIMALS = Number(process.env.VITE_SPROTO_DECIMALS ?? 6);
const MAX_UI_AMOUNT = Number(process.env.SPROTO_WITHDRAW_MAX ?? 100_000_000);
